...
// sample(샘플)
public class JavaWebCrawler_sam {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
	    ...
	    HttpPost http = new HttpPost("http://cu.bgfretail.com/product/view.do?category=event&gdIdx=785");
	    ...
	    Document doc2 = Jsoup.connect("http://cu.bgfretail.com/product/view.do?category=event&gdIdx=785").get();
