						...
						<div class="row">
							...
							<div class="col-md-3 col-lg-3 hidden-xs hidden-sm"> <!-- hidden-xs hidden-sm : 폰,태블릿사이즈에서 안보임 : 데스크탑용 -->
								...
								<img class="img-circle"
									...
									alt="User Pic">
							    -->
								<img class="img-circle" src="<c:url value='${member.pic_name}' />" alt="User Pic" width="130px;" height="130px;" />
							</div>
							
							<div class="col-xs-2 col-sm-2 hidden-md hidden-lg">  <!-- 데스크탑에서 안보임 : 모바일용-->
								<img class="img-circle" src="<c:url value='${member.pic_name}' />" alt="User Pic">
							</div>
