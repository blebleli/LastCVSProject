				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						...
						<div class="wthree_banner_btm_pos">
							<h3>Best<span>best store</span> Best <i>GOGOCVS</i></h3>
						</div>
					</div>
				</div>
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						...
						<div class="wthree_banner_btm_pos1">
							<h3>Best <span>Best</span> Best</h3>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
...
<!-- --------------------------------------------------------- -->
<!-- --------------------------------------------------------- -->
									<a> <span class="image"><img src="/images/img.jpg"
											alt="Profile Image" /></span> <span> <span>John Smith</span>
											<span class="time">Best 1</span>
									</span> <span class="message"> </span>
									</a>
<!-- --------------------------------------------------------- -->
									
									<p>Film festivals used to be
											do-or-die moments for movie makers. They were where...</p>
