...
<div class="agileits_header">
	...
	<div class="w3l_header_right">
		<!-- 헤더 오른쪽 사람모양 마우스오버시 메뉴dropdown-menu  ★ 이동 경로 주기(로그인,회원가입화면) --> <!-- 회원가입 이동 제거 2018-09-03-jw  -->
		<ul>
...
<!-- 							<li><a href="userLogin.jsp">회원가입</a></li> -->
	...
	<div class="w3l_header_right1">
		<!-- 관리자 문의하기 링크 /  삭제??????  --> <!-- 추후 협의 2018-09-03-jw -->
		<h2>
			<a href="mail.html">뭐들어가지?</a><!-- 추후 협의 2018-09-03-jw -->
		</h2>
	</div>
