...
public class SupplyListVo {
	...
	private String splylist_exdate;                               // 유통기한
	...
	public SupplyListVo(String splylist_id, String splylist_info,
			String splylist_exdate, int splylist_sum, String supply_bcd,
			String prod_id) {
		super();
	...
	public String getSplylist_exdate() {
		return splylist_exdate;
	}
	public void setSplylist_exdate(String splylist_exdate) {
		this.splylist_exdate = splylist_exdate;
	}
