...
//		Random random = new Random();
		String[] date = {"2018-10-11","2018-10-12","2018-10-13","2018-10-14","2018-10-15","2018-10-16","2018-10-17"}; // 날짜
		...
		for ( int x = 0; x < date.length; x++) { // 날짜 11 ~ 17
			
			for ( int a = 0; a < state.length; a++) { // 발주, 승인, 입고
			
				for ( int i = 0; i < mem_id.length; i++){ // 편의점 400곳
...
//					}
					...
					for (int z = 0; z < prod_ids.length; z++){ // 수불리스트 고정 30개
						// 수량 1개~10개
						// 수불리스트 insert 코딩하기			
					}					
