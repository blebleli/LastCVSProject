...
//		resultS = dao.insert("tableInsert.supplyInsert", svo);
		...
		for ( int i = 0 ; i<prod_id.length; i++) {
			String sup = auto.autoCode("SUP10","3090000-104-2016-00061");
			...
			slvo.setSupply_bcd("SUPPLY-f96c54d3-7e3c-4362-a493-94c6313718b1");
