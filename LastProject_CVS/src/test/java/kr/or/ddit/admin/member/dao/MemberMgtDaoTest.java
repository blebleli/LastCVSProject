...
public class MemberMgtDaoTest {
	 ...
	 * 작성자 : 김마음
	 * 변경이력 : 신규
	 * Method 설명 : memberMgtDao가 비어있는지 확인
	 */	
	@Test
	public void bintest() {
		assertNotNull("memberMgtDao");
	}
	...
	public void getMemberPageListTest(){
		...
		List<MemberVo> memberList = memberMgtDao.getMemberPageList(memberVo);
	...
	public void deleteCvsMemberTest() {
		...
		memberMgtDao.deleteCvsMember(memberVo);
